    ...
    <script>
      $(function () {
        $('.js-side-link').on('click', function (e) {
          ...
          if (url === 'profile.php' || url === 'compensation.php' || url === 'timeoff.php' || url === 'settings.php' || url === 'progressive-discipline.php' || url === 'inventory.php' || irPages.indexOf(pathOnly) !== -1 || url === 'index.php') {
