                            ...
                            <?php foreach ($receivedRows as $rr): ?>
                                <tr class="transition-colors hover:bg-amber-50/40">
                                    ...
                                    <td class="px-6 py-4 sm:px-8">
                                        <a href="performance-review-received.php?id=<?php echo (int)($rr['id'] ?? 0); ?>" class="inline-flex items-center gap-1.5 rounded-xl border border-amber-200/90 bg-amber-50/80 px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-amber-900 transition hover:border-amber-300 hover:bg-amber-100">
                                            View
