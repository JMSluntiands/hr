...
$postResult = hr_performance_review_handle_post($conn, $employeeDbId, (string)$department, 'performance.php?saved=1');
if ($postResult !== null) {
    ...
    <main class="min-h-screen overflow-y-auto bg-gradient-to-b from-slate-100 via-[#f1f5f9] to-slate-100/90 p-4 pt-16 md:ml-64 md:p-8 md:pt-8">
        ...
        <header class="relative overflow-hidden rounded-3xl border border-white/60 bg-white p-6 shadow-xl shadow-slate-200/40 ring-1 ring-slate-200/50 sm:p-8">
            ...
            <div class="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <a href="performance-review-submissions.php" class="inline-flex shrink-0 items-center justify-center gap-2 rounded-2xl border border-amber-200/90 bg-gradient-to-br from-amber-50 to-white px-4 py-3 text-sm font-semibold text-amber-900 shadow-sm transition hover:border-amber-300 hover:shadow-md">
