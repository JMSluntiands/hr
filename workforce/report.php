...
<body class="font-inter bg-[#f1f5f9] min-h-screen">
    ...
    <main class="min-h-screen overflow-y-auto p-4 pt-16 md:pt-8 md:ml-64 md:p-8">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-slate-800">Report</h1>
            <p class="text-sm text-slate-500 mt-1">Workforce Management System – reports and analytics</p>
        </div>
        ...
        <section class="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
            ...
            <p class="text-sm text-slate-600">
                Workforce reports (attendance, payroll, headcount, etc.) will be available here.
            </p>
        </section>
    </main>
