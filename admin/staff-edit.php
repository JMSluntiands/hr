    ...
    <div class="page-wrapper">
      <div class="content container-fluid">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-sub-header">
                ...
                <ul class="breadcrumb">
                  <li class="breadcrumb-item"><a href="client.php">Staff List</a></li>
        ...
        <form id="updateClientForm" class="shadow p-4 rounded bg-white">
          <input type="hidden" name="original_code" value="<?php echo htmlspecialchars($client['staff_id']); ?>">

          <div class="mb-3">
            <label class="form-label fw-bold">Client Code</label>
            <input type="text" name="client_code" class="form-control" 
                   value="<?php echo htmlspecialchars($client['staff_id']); ?>" required>
          </div>
  ...
  <script>
    $(document).ready(function() {
      $("#updateClientForm").submit(function(e) {
        ...
        $.ajax({
          url: "../controller/staff/update-staff.php",
          type: "POST",
          data: $(this).serialize(),
          dataType: "json",
          ...
          error: function(xhr) {
            toastr.error("Error updating staff: " + xhr.responseText);
          }
        });
      });
    });
