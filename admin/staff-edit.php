                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select name="emergency_contact_relationship" id="emergency_contact_relationship" class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d97706]/20 focus:border-[#d97706] bg-white">
                                ...
                                <option value="Partner" <?php echo ((isset($_POST['emergency_contact_relationship']) && $_POST['emergency_contact_relationship'] === 'Partner') || (!isset($_POST['emergency_contact_relationship']) && ($employee['emergency_contact_relationship'] ?? '') === 'Partner')) ? 'selected' : ''; ?>>Partner</option>
                                ...
                                <option value="Grandmother" <?php echo ((isset($_POST['emergency_contact_relationship']) && $_POST['emergency_contact_relationship'] === 'Grandmother') || (!isset($_POST['emergency_contact_relationship']) && ($employee['emergency_contact_relationship'] ?? '') === 'Grandmother')) ? 'selected' : ''; ?>>Grandmother</option>
                                <option value="Grandfather" <?php echo ((isset($_POST['emergency_contact_relationship']) && $_POST['emergency_contact_relationship'] === 'Grandfather') || (!isset($_POST['emergency_contact_relationship']) && ($employee['emergency_contact_relationship'] ?? '') === 'Grandfather')) ? 'selected' : ''; ?>>Grandfather</option>
