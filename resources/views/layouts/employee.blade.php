...
<head>
    ...
    <title>@yield('title', 'Employee - Luntian HR')</title>
...
<body class="font-inter min-h-screen bg-gradient-to-br from-slate-100 via-slate-50 to-orange-50/30">
    @include('partials.employee-sidebar')
    <main class="min-h-screen p-4 pt-16 md:pt-8 md:ml-64 md:p-8 lg:p-10">
        @if(session('success'))
