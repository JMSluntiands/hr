...
@section('title', 'Timekeeping — In Progress')

@section('content')
<div class="w-full max-w-lg">
    <div class="bg-white rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden text-center">
        <div class="h-1.5 bg-gradient-to-r from-blue-500 via-indigo-500 to-indigo-600"></div>
        <div class="px-6 md:px-10 py-10 md:py-12">
            <div class="mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center shadow-lg mb-6">
                <i class="fa fa-calendar-check-o text-2xl" aria-hidden="true"></i>
            </div>
            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-2">Timekeeping Module</p>
            ...
            <p class="text-slate-500 text-sm md:text-base leading-relaxed max-w-sm mx-auto">
                Ang Timekeeping module (daily timesheet, work hours, at payslip) ay ginagawa pa. Balik ka na lang mamaya.
            </p>
            ...
            <a href="{{ route('employee.module-select') }}"
