            ...
            <section>
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="ir_report_date" type="date" name="report_date" value="<?php echo $v('report_date', function_exists('hr_today_ymd') ? hr_today_ymd() : date('Y-m-d')); ?>" required class="<?php echo $inputBase; ?>">
                    </div>
                    <div>
