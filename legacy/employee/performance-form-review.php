...
$postResult = hr_performance_review_handle_post(
    ...
    $employeeDbId,
    (string) $department,
    hr_performance_employee_url('performance-form-review.php', 'performance/form-review', 'saved=1')
);
if ($postResult !== null) {
...
<?php include __DIR__ . '/include/performance-pages-body-shell.php'; ?>
    ...
    <main class="min-h-screen overflow-y-auto bg-gradient-to-b from-slate-100 via-[#f1f5f9] to-slate-100/90 p-4 pt-16 md:ml-64 md:p-8 md:pt-8">
        ...
        <?php
        $formAction = hr_performance_employee_url('performance-form-review.php', 'performance-form-review.php');
        $defaultStaffName = '';
