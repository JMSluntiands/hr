    ...
    <main class="min-h-screen overflow-y-auto p-4 pt-16 md:ml-64 md:p-8 md:pt-8">
        <div class="mx-auto max-w-3xl space-y-6">
            <div class="flex flex-wrap items-center gap-3">
                <a href="<?php echo htmlspecialchars(hr_performance_employee_url('performance-my-reviews.php', 'performance/my-reviews'), ENT_QUOTES, 'UTF-8'); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-amber-800 hover:text-amber-950 hover:underline">
