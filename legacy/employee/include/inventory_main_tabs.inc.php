                    ...
                    <div class="w-full min-w-0 space-y-6">
                        ...
                        <article class="rounded-2xl border border-slate-200 bg-white shadow-md ring-1 ring-slate-900/5 w-full min-w-0 overflow-hidden">
                            <div class="flex items-center gap-2 px-4 py-3 border-b border-slate-100 bg-slate-50/90">
                                ...
                                <div>
                                    <h2 class="text-base font-semibold text-slate-800">Decommission history</h2>
                                    <p class="text-xs text-slate-500">Your submitted requests and reviewer status</p>
                                </div>
                            </div>
                        ...
                        <article class="rounded-2xl border border-slate-200 bg-white shadow-md ring-1 ring-slate-900/5 w-full min-w-0 overflow-hidden">
                            <div class="px-4 py-3 border-b border-[#e8870a] bg-[#FA9800] text-white">
                                <div class="flex items-center gap-2">
                                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                    </svg>
                                    <div>
                                        <h2 class="text-base font-semibold">Decommission Request</h2>
                                        <p class="text-xs text-white/90 mt-0.5">Submit a new equipment decommissioning request</p>
                                    </div>
                                </div>
                            </div>
                            <div class="p-4 md:p-6 lg:p-8 bg-slate-50/40">
                                <h3 class="text-center text-lg font-bold text-slate-900 mb-2">Equipment Decommissioning Request Form</h3>
                                <p class="text-center text-xs text-slate-500 mb-6 max-w-2xl mx-auto">Fill out this form to request decommissioning of an item allocated to you. Your request will appear in the history table above after submission.</p>
                                <?php if (empty($allocatedItems)): ?>
