        ...
        $(function() {
            ...
            $(document).on('click', '.view-leave-btn', function() {
                ...
                var html = '<div class="space-y-4">' +
                    ...
                    '</div>' +
                    '<div class="bg-blue-50 rounded-lg p-4 border border-blue-200">' +
                    '<div class="text-xs font-medium text-blue-600 uppercase tracking-wide mb-1">Return Date</div>' +
                    ...
                    '</div>' +
                    '<div class="bg-slate-50 rounded-lg p-4 border border-slate-200">' +
                    '<div class="text-xs font-medium text-slate-500 uppercase tracking-wide mb-2">Remarks</div>' +
