...
// Dashboard notification icon: open the most relevant pending queue
$bellHref = 'request-leaves';
if ($docUploadCount > 0) {
    $bellHref = 'request-upload';
} elseif ($docRequestCount > 0) {
    $bellHref = 'request-document';
} elseif ($leaveCount > 0) {
    $bellHref = 'request-leaves';
} elseif ($reimbursementCount > 0) {
    $bellHref = 'reimbursement-review';
}
    ...
    <main class="min-h-screen overflow-y-auto p-4 pt-16 md:pt-8 md:ml-64 md:p-8">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo htmlspecialchars($bellHref); ?>" class="relative w-9 h-9 rounded-full bg-white shadow flex items-center justify-center text-slate-500 hover:bg-slate-50 transition-colors">
            ...
            <div class="p-6 text-sm text-slate-600 space-y-3">
                ...
                <?php else: ?>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs text-slate-400"><?php echo htmlspecialchars(hr_time_ago($activity['created_at'] ?? '')); ?></span>
                    </div>
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
