    ...
    <main class="min-h-screen overflow-y-auto p-4 pt-16 md:pt-8 md:ml-64 md:p-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">View all system activities and actions. <span class="text-slate-600">Date and time are Philippine Standard Time (Asia/Manila).</span></p>
            </div>
        </div>
                ...
                <table id="activityTable" class="min-w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-slate-100 hover:bg-slate-50">
                            <td class="px-4 py-3 text-slate-600 whitespace-nowrap"><?php echo htmlspecialchars(hr_format_datetime_manila($log['created_at'] ?? '', 'M d, Y h:i:s A')); ?></td>
                            <td class="px-4 py-3">
